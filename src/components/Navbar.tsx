  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled ? "bg-background/95 backdrop-blur-md border-b border-border shadow-gold" : "bg-transparent"
      }`}
    >
          ...
          >
            <div className="flex flex-col items-center gap-4 py-6">
              ...
              <a
                href="#contact"
                onClick={() => setMobileOpen(false)}
                className="bg-gradient-gold text-primary-foreground px-5 py-2 rounded-md text-sm font-semibold"
              >
                Get a Free Quote
              </a>
            </div>
